...
public enum NativeFunction {
	...
	/* 13*/ RUN_TEXT("bool singleLine, int textID, int withInteraction, Object object"),
	/* 14*/ TEMP_TEXT("bool singleLine, StrPtr string, int withInteraction, Object zero"),
	/* 15*/ TEXT_READ("", "bool"),
	...
	/*225*/ RUN_TEXT_WITH_NUMBER("bool alwaysFalse, int string, float number, int alwaysZero, Object obj"),
